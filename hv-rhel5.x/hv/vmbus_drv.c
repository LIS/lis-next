...
static void fastcall vmbus_flow_handler(unsigned int irq, struct irq_desc *desc, struct pt_regs *regs) //KYS
{
	//KYSkstat_incr_irqs_this_cpu(irq, desc);
...
static int vmbus_bus_init(int irq)
{
	 ...
	 */
	//KYSset_irq_handler(irq, vmbus_flow_handler);
