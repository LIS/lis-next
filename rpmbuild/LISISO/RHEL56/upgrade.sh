...
if [ "$osbit" == "x86_64" ]; then
       {
              kmodrpm=`ls lis-56/x86_64/kmod-microsoft-hyper-v-*.x86_64.rpm`
              msrpm=`ls lis-56/x86_64/microsoft-hyper-v-*.x86_64.rpm`
       }
        ...
        if [ "$PAE" == "" ]; then
        {
              kmodrpm=`ls lis-56/x86/kmod-microsoft-hyper-v-4*.i686.rpm`
              msrpm=`ls lis-56/x86/microsoft-hyper-v-*.i686.rpm`
        }
        else
        {
              kmodrpm=`ls lis-56/x86/kmod-microsoft-hyper-v-PAE-*.i686.rpm`
              msrpm=`ls lis-56/x86/microsoft-hyper-v-*.i686.rpm`
        }
        fi
